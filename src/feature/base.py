...
class BaseFeatureTransformer(ABC):
    ...
    @staticmethod
    def _take_absolute_difference_between_date_columns_in_years(df:pd.DataFrame,
                                                                date_column_1:str,
        ...
        df[created_column] = abs(df[date_column_1].dt.year - df[date_time_column_2].dt.year)
        return df
